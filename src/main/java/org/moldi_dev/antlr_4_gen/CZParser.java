...
public class CZParser extends Parser {
	...
	public static final int
		...
		SWITCH=17, CASE=18, DEFAULT=19, QUESTION=20, COLON=21, SEMICOLON=22, COMMA=23, 
		LEFT_PARANTHESIS=24, RIGHT_PARANTHESIS=25, LEFT_BRACE=26, RIGHT_BRACE=27, 
		ASSIGNMENT=28, MODULUS=29, EQUALS=30, NOT=31, NOT_EQUALS=32, LESS_THAN=33, 
		GREATER_THAN=34, LESS_THAN_OR_EQUAL=35, GREATER_THAN_OR_EQUAL=36, ADDITION=37, 
		SUBTRACTION=38, MULTIPLICATION=39, DIVISION=40, LOGICAL_AND=41, LOGICAL_OR=42, 
		BITWISE_AND=43, BITWISE_OR=44, BITWISE_XOR=45, BITWISE_NOT=46, SHIFT_LEFT=47, 
		SHIFT_RIGHT=48, STRING_LITERAL=49, CHARACTER=50, INTEGER_NUMBER=51, DOUBLE_NUMBER=52, 
		IDENTIFIER=53, COMMENT=54, WS=55, UNEXPECTED_CHAR=56;
	public static final int
		...
		RULE_return_statement = 11, RULE_function_call = 12, RULE_arguments = 13, 
		RULE_declaration = 14, RULE_assignment = 15, RULE_print_statement = 16, 
		RULE_print_arguments = 17, RULE_read_statement = 18, RULE_if_statement = 19, 
		RULE_while_statement = 20, RULE_for_statement = 21, RULE_for_init = 22, 
		RULE_block = 23, RULE_expression = 24, RULE_literal = 25, RULE_boolean_literal = 26, 
		RULE_type_ = 27;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"continue_statement", "return_statement", "function_call", "arguments", 
			"declaration", "assignment", "print_statement", "print_arguments", "read_statement", 
			"if_statement", "while_statement", "for_statement", "for_init", "block", 
			"expression", "literal", "boolean_literal", "type_"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"SWITCH", "CASE", "DEFAULT", "QUESTION", "COLON", "SEMICOLON", "COMMA", 
			"LEFT_PARANTHESIS", "RIGHT_PARANTHESIS", "LEFT_BRACE", "RIGHT_BRACE", 
			"ASSIGNMENT", "MODULUS", "EQUALS", "NOT", "NOT_EQUALS", "LESS_THAN", 
			"GREATER_THAN", "LESS_THAN_OR_EQUAL", "GREATER_THAN_OR_EQUAL", "ADDITION", 
			"SUBTRACTION", "MULTIPLICATION", "DIVISION", "LOGICAL_AND", "LOGICAL_OR", 
			"BITWISE_AND", "BITWISE_OR", "BITWISE_XOR", "BITWISE_NOT", "SHIFT_LEFT", 
			"SHIFT_RIGHT", "STRING_LITERAL", "CHARACTER", "INTEGER_NUMBER", "DOUBLE_NUMBER", 
	...
	public final Switch_blockContext switch_block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 17521819531804414L) != 0)) {
				{
				{
				setState(137);
				statement();
	...
	public final Return_statementContext return_statement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 17521819464523776L) != 0)) {
				{
				setState(158);
				expression(0);
				}
	...
	public final Print_argumentsContext print_arguments() throws RecognitionException {
		...
		enterRule(_localctx, 34, RULE_print_arguments);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final For_statementContext for_statement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 9007199254741022L) != 0)) {
				{
				setState(235);
				for_init();
				}
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						_la = _input.LA(1);
						if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 1649804312576L) != 0)) ) {
						...
						setState(276);
						((MultiplicativeExpressionContext)_localctx).right = expression(12);
						}
						break;
					case 2:
						{
						...
						setState(279);
						((AdditiveExpressionContext)_localctx).right = expression(11);
						}
						break;
					case 3:
						{
						...
						setState(282);
						((ShiftExpressionContext)_localctx).right = expression(10);
						}
						break;
					case 4:
						{
						...
						setState(285);
						((RelationalExpressionContext)_localctx).right = expression(9);
						}
						break;
					case 5:
						{
						...
						setState(288);
						((EqualityExpressionContext)_localctx).right = expression(8);
						}
						break;
					case 6:
						{
						...
						setState(291);
						((BitwiseExpressionContext)_localctx).right = expression(7);
						}
						break;
					case 7:
						{
					...
					case 8:
						...
						match(COLON);
						setState(299);
						((TernaryExpressionContext)_localctx).falseExpr = expression(5);
						}
						break;
					}
					} 
